...
function createFeatures(earthquakeData) {
  ...
  // Creates markers for each earthquake 
  ...
  function onEachFeature(feature, layer) {
    ...
    //   layer.on({
    //     // On mouse over, make the feature (earthquake) more visible
    ...
    //     },
    //     // When a feature (earthquake) is clicked, fit that feature to the screen
